...
public abstract class ParticularObject extends GameObject{
	...
	protected Animation deathForwardAnim, deathBackAnim;
	...
	public ParticularObject(float x, float y, float width, float height, float mass, int blood,
			GameWorld gameWorld) {
	...
	// Kiểm tra đối tượng có ra khởi vùng Camera.
